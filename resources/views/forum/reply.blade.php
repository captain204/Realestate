    ...
    <div class="container">
      <div class="row">
          <div class="col-md-10 offset-2">
            <h4>{{ $post->title }} <h4>
              <h3 class="text-center"> Reply to this topic <h3>
            <form action="forum/postReply" method="post" enctype="multipart/form-data">
                {{ csrf_field()}}
                <div class="form-group">
                        <input type="hidden" name="post_id"  value="{{ $post->id }}" class="form-control">
                </div>
                <div class="form-group">
                        <input type="hidden" name="user_id" id="user_id" value="{{ Session::get('id') }}" class="form-control">
                </div>
                <div class="form-group">
                        <label>Body</label>
