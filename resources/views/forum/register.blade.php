    ...
    <div class="container">
      <div class="row">
          <div class="col-md-10 offset-2">
            ...
            <form action="register.php" method="post" class="text-center"  role ="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    name="about" placeholder="Tell us aboout yourself(optional)"></textarea>
                </div>
